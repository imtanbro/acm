...
const rotate = () => {
    const cubes = document.querySelectorAll('.cube1');
...
document.querySelector('.left-arrow1').addEventListener('click', () => {
    x += 90;
    rotate();
    if (bool) {
        playPause();
...
document.querySelector('.left-arrow1').addEventListener('mouseover', () => {
    x += 25;
    rotate();
});

document.querySelector('.left-arrow1').addEventListener('mouseout', () => {
    x -= 25;
    rotate();
});
